...
function LightboxPage(issue,page) {
	...
	$('#share-twitter').attr('href','https://twitter.com/intent/tweet?url=http%3A%2F%2Fafghanistan.derwesten-recherche.de%2F%23%21%2F'+issue+'-'+page+'&text=Die+Afghansistan+Papiere%2C+Ausgabe+'+conf.week+'%2F'+conf.year+'+Seite+'+page+'+%23%21%2Fafghanistan+%23%21%2Fleak&via=wazrechereche&related=wazrechereche');
